...
type CharityCampaignStartEvent struct {
	...
	CurrentAmount      charityCampaignStartEventCurrentAmount `json:"current_amount"`      // An object that contains the current amount of donations that the campaign has received.
	TargetAmount       charityCampaignStartEventTargetAmount  `json:"target_amount"`       // An object that contains the campaign’s target fundraising goal.
