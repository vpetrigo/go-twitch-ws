...
var (
	eventSubTypes = map[string]eventSubScope{
		...
		"channel.shield_mode.begin":                              {Version: "1", MsgType: &eventsub.ShieldModeEvent{}, ConditionType: &eventsub.ShieldModeEventCondition{}},
		"channel.shield_mode.end":                                {Version: "1", MsgType: &eventsub.ShieldModeEvent{}, ConditionType: &eventsub.ShieldModeEventCondition{}},
