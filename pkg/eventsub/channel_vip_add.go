...
type ChannelVIPAddEvent struct {
	UserID               string `json:"user_id"`                // The ID of the user who was added as a VIP.
	UserLogin            string `json:"user_login"`             // The login of the user who was added as a VIP.
	UserName             string `json:"user_name"`              // The display name of the user who was added as a VIP.
