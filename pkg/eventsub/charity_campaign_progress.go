...
type CharityCampaignProgressEvent struct {
	...
	CurrentAmount      charityCampaignProgressEventCurrentAmount `json:"current_amount"`      // An object that contains the current amount of donations that the campaign has received.
	TargetAmount       charityCampaignProgressEventTargetAmount  `json:"target_amount"`       // An object that contains the campaign’s target fundraising goal.
}
